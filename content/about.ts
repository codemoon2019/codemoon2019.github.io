export const aboutContent = {
  whoIAm: {
    title: "Who I Am",
    paragraphs: [
      "I am Al Andrew Paul Beltran — also Al Andrew Paul Teodosio Beltran — a full-stack software engineer based in Manila, Philippines, and the founder of Momentra Labs. Independently I developed RentaraH, Lumina, Gloves Up, PocketPOS, and QuickCart. Online I also go by Al Beltran and Code by Pawpu. This site (albeltran.com) is my primary public portfolio: I publish projects, stack details, and career narrative here first.",
